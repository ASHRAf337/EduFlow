            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">Log to <a href="index.php"><span class="brand-name">Eduflow Admin</span></a>
                        </h1>
                        <form class="text-left" method='post'>
                            <div class="form">
                                ...
                                <div class="d-sm-flex justify-content-between mt-5">
                                    ...
                                    <div class="field-wrapper">
                                        <button type="button" class="btn btn-lg btn-danger" value="" name=''
                                            onclick="window.location.href='students/'">Student</button>
                                    </div>

                                    <div class="field-wrapper">
                                        <button type="button" class="btn btn-lg btn-danger" value="" name=''
                                            onclick="window.location.href='faculty/'">Faculty</button>
                                    </div>
