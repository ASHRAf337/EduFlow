                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="answer" class="form-control"
                                                            id="exampleInputPassword1" placeholder="Response"
                                                            required></textarea>
                                                    </div>
                                                </div>
...
<?php
	...
	$answer=$_POST['answer'];
				...
				if(mysqli_query($con,"UPDATE `qanda` SET `message`='$answer',`status`='closed' WHERE id='$id'"))
					{
						
						echo "<script language='JavaScript' type='text/javascript'>
						alert('Answer Given Successfully');
						</script>";
					echo "<script> window.location.assign('qanda.php'); </script>";
					}
					else
					{
						echo "<script language='JavaScript' type='text/javascript'>
